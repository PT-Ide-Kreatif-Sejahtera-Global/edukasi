...
export default function Testimonials() {
    return (
        <div className="grid grid-cols-1 sm:grid-cols-5 bg-lime-500 mt-16 md:mt-48 p-10 gap-6">
            <div className="row-span-2 sm:col-span-2 bg-white shadow-md rounded-lg h-full m-auto w-full">
