...
const ChatComponent = () => {
    ...
    return (
        <div className="relative">
            ...
            <button
                onClick={toggleChat}
                className="fixed bottom-4 right-4 bg-lime-500 text-white rounded-full p-3 shadow-lg hover:bg-lime-600 transition duration-300 flex items-center"
            >
                ...
                {isChatOpen ? (
                    ...
                    <>
                        ...
                        <span className="ml-2 font-bold">Konsultasi</span>
                    </>
                )}
            </button>
