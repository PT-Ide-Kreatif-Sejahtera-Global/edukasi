...
export default function CourseCategoryIndex({ categories }) {
    console.log(categories);
    const currentPage = categories.current_page || 1; // Default to 1 if current_page is undefined
    const itemsPerPage = categories.per_page || 10; // Default to 10 if per_page is undefined

    return (
        <AdminLayout title="Kategori Kursus">
            <Head title="Daftar Kategori Kursus" />
                    ...
                    <div className="sm:flex sm:items-center">
                        <div className="sm:flex-auto">
                            <h1 className="text-base font-semibold text-gray-900">
                                Total Kategori Kursus: {categories.total}
                            </h1>
                        </div>
