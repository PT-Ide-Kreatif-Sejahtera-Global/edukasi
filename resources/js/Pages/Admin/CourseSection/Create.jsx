...
export default function CreateSection({ errors }) {
    ...
    return (
        <AdminLayout title="Tambah Kategori Kursus">
            <Head title="Tambah Kategori Kursus" />
