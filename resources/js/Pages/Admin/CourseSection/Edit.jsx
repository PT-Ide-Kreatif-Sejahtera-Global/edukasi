...
export default function EditSection({ section, errors, user }) {
    ...
    const submit = (e) => {
        ...
        put(route("updatesection", section.id), {
            preserveScroll: true,
            onSuccess: () => {
                <SuccessDialog
                    isOpen={open}
                    ...
                    title="Berhasil"
                    message="Berhasil Mengubah Section Kursus"
                    buttonText="Tutup"
                />;
                setData({
                    name: "",
            ...
            onError: () => {
                <ErrorDialog
                    ...
                    onClose={() => setOpen(false)}
                    title="Error"
                    message="Gagal Mengubah Section Kursus"
                    buttonText="Tutup"
                />;
            },
        });
